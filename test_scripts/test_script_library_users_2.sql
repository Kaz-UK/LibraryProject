...
select book.author, book.title, book.publisher, book.published_date, book.subject_heading, copy_id, copy.location, copy.classmark, copy.loan_status from book
inner join copy on book.accession_id=copy.accession_id
