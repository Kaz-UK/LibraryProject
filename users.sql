...
grant select on library.copies to 'opac_user'@'localhost';
...
grant select on library.copies to 'library_user'@'localhost';
grant select on library.loans to 'library_user'@'localhost';
grant select on library.reservations to 'library_user'@'localhost';
...
grant insert on library.reservations to 'library_user'@'localhost';
...
grant delete on library.copies to 'administrator'@'localhost';
-- grant access to procedures
