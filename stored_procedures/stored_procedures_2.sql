...
BEGIN 
	SELECT loan_status FROM copy WHERE accession_id = id;
END //
DELIMITER ;
...
BEGIN 
	INSERT INTO loan (date_issued, date_due, user_id, copy_id) VALUES (_date_issued, _date_due, _user_id, _copy_id);
	UPDATE copy  SET loan_status = 'On loan' WHERE copy_id = _copy_id;
END //
DELIMITER ;
